-- ----------------------------------------------------------------
-- DataNucleus SchemaTool (ran at 11/11/2022 11:39:58)
-- ----------------------------------------------------------------
...
(
    ...
    "VULNERABLESOFTWARE_ID" int4 NOT NULL
);
...
CREATE INDEX "ANALYSIS_N50" ON "ANALYSIS" ("PROJECT_ID");
...
CREATE INDEX "VIOLATIONANALYSIS_N49" ON "VIOLATIONANALYSIS" ("POLICYVIOLATION_ID");

CREATE INDEX "VIOLATIONANALYSIS_N51" ON "VIOLATIONANALYSIS" ("PROJECT_ID");
...
CREATE INDEX "TEAMS_PERMISSIONS_N50" ON "TEAMS_PERMISSIONS" ("TEAM_ID");

CREATE INDEX "TEAMS_PERMISSIONS_N49" ON "TEAMS_PERMISSIONS" ("PERMISSION_ID");
...
CREATE INDEX "APIKEYS_TEAMS_N49" ON "APIKEYS_TEAMS" ("TEAM_ID");

CREATE INDEX "APIKEYS_TEAMS_N50" ON "APIKEYS_TEAMS" ("APIKEY_ID");
