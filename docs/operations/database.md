...
This behavior can be turned off by setting the [`RUN_MIGRATIONS`](../../reference/configuration/api-server/#runmigrations)
environment variable of the API server container to `false`.
...
* [`DATABASE_MIGRATION_URL`](../../reference/configuration/api-server/#databasemigrationurl)
* [`DATABASE_MIGRATION_USERNAME`](../../reference/configuration/api-server/#databasemigrationusername)
* [`DATABASE_MIGRATION_PASSWORD`](../../reference/configuration/api-server/#databasemigrationpassword)
