...
3. Create a new alert with publisher *Outbound Webhook*
   ![Create Alert](./images/demo_dtrack_create-alert.png)
4. Select a few notification groups and enter a destination URL ([Pipedream](https://pipedream.com/) is convenient for testing Webhooks)
   ![Configure Alert](./images/demo_dtrack_configure-alert.png)
...
11. Going back to the service you used as Webhook destination, you should see that a few alerts have been delivered
    ![Webhook Notifications](./images/demo_webhook_notifications.png)
...
![Consumer Groups in Redpanda Console as per default configuration](./images/demo_redpanda-console_consumer-groups_default.png)
...
![Detailed view of the dtrack-vuln-analyzer consumer group](./images/demo_redpanda-console_consumer-groups_default-detailed.png)
