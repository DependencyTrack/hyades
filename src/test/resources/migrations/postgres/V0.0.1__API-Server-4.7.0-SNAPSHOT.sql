-- ----------------------------------------------------------------
-- DataNucleus SchemaTool (ran at 17/11/2022 10:21:04)
-- ----------------------------------------------------------------
...
(
    ...
    "LAST_VULNERABILITY_ANALYSIS" timestamptz NULL,
...
-- Table "CONFIGPROPERTY" for classes [alpine.model.ConfigProperty]
...
(
    "NOTIFICATIONRULE_ID" int4 NOT NULL,
    "TEAM_ID" int8 NULL
);
...
CREATE INDEX "COMPONENT_N49" ON "COMPONENT" ("LICENSE_ID");
...
CREATE INDEX "ANALYSIS_N51" ON "ANALYSIS" ("COMPONENT_ID");

CREATE INDEX "ANALYSIS_N50" ON "ANALYSIS" ("VULNERABILITY_ID");
...
CREATE INDEX "FINDINGATTRIBUTION_N50" ON "FINDINGATTRIBUTION" ("COMPONENT_ID");
...
-- Constraints for table "CONFIGPROPERTY" for class(es) [alpine.model.ConfigProperty]
...
CREATE INDEX "MAPPEDOIDCGROUP_N50" ON "MAPPEDOIDCGROUP" ("GROUP_ID");

CREATE INDEX "MAPPEDOIDCGROUP_N49" ON "MAPPEDOIDCGROUP" ("TEAM_ID");
...
ALTER TABLE "BOM" ADD CONSTRAINT "BOM_UPLOAD_TOKEN_IDX" UNIQUE ("UPLOAD_TOKEN");
...
CREATE INDEX "OIDCUSERS_PERMISSIONS_N49" ON "OIDCUSERS_PERMISSIONS" ("OIDCUSER_ID");

CREATE INDEX "OIDCUSERS_PERMISSIONS_N50" ON "OIDCUSERS_PERMISSIONS" ("PERMISSION_ID");
...
CREATE INDEX "COMPONENTS_VULNERABILITIES_N50" ON "COMPONENTS_VULNERABILITIES" ("VULNERABILITY_ID");

CREATE INDEX "COMPONENTS_VULNERABILITIES_N49" ON "COMPONENTS_VULNERABILITIES" ("COMPONENT_ID");
...
CREATE INDEX "SERVICECOMPONENTS_VULNERABILITIES_N49" ON "SERVICECOMPONENTS_VULNERABILITIES" ("SERVICECOMPONENT_ID");

CREATE INDEX "SERVICECOMPONENTS_VULNERABILITIES_N50" ON "SERVICECOMPONENTS_VULNERABILITIES" ("VULNERABILITY_ID");
...
CREATE INDEX "VULNERABLESOFTWARE_VULNERABILITIES_N49" ON "VULNERABLESOFTWARE_VULNERABILITIES" ("VULNERABILITY_ID");

CREATE INDEX "VULNERABLESOFTWARE_VULNERABILITIES_N50" ON "VULNERABLESOFTWARE_VULNERABILITIES" ("VULNERABLESOFTWARE_ID");
...
CREATE INDEX "MANAGEDUSERS_PERMISSIONS_N50" ON "MANAGEDUSERS_PERMISSIONS" ("MANAGEDUSER_ID");

CREATE INDEX "MANAGEDUSERS_PERMISSIONS_N49" ON "MANAGEDUSERS_PERMISSIONS" ("PERMISSION_ID");
...
CREATE INDEX "NOTIFICATIONRULE_PROJECTS_N50" ON "NOTIFICATIONRULE_PROJECTS" ("NOTIFICATIONRULE_ID");

CREATE INDEX "NOTIFICATIONRULE_PROJECTS_N49" ON "NOTIFICATIONRULE_PROJECTS" ("PROJECT_ID");
...
CREATE INDEX "PROJECT_ACCESS_TEAMS_N50" ON "PROJECT_ACCESS_TEAMS" ("PROJECT_ID");

CREATE INDEX "PROJECT_ACCESS_TEAMS_N49" ON "PROJECT_ACCESS_TEAMS" ("TEAM_ID");
