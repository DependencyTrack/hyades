-- ----------------------------------------------------------------
-- DataNucleus SchemaTool (ran at 09/11/2022 19:21:59)
-- ----------------------------------------------------------------
...
CREATE INDEX "ANALYSIS_N49" ON "ANALYSIS" ("COMPONENT_ID");
...
CREATE INDEX "LDAPUSERS_TEAMS_N49" ON "LDAPUSERS_TEAMS" ("LDAPUSER_ID");

CREATE INDEX "LDAPUSERS_TEAMS_N50" ON "LDAPUSERS_TEAMS" ("TEAM_ID");
