...
import org.hyades.persistence.model.IConfigProperty.PropertyType;
...
public enum ConfigPropertyConstants {
    ...
    SCANNER_SNYK_API_ORG_ID("scanner", "snyk.org.id", null, PropertyType.STRING, "The org id to use for Snyk API"),
