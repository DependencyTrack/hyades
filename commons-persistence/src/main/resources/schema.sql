...
CREATE FUNCTION public.project_hierarchy_maintenance_on_project_insert() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
            begin
...
CREATE FUNCTION public.project_hierarchy_maintenance_on_project_update() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
            begin
...
CREATE TABLE public."PROJECT_HIERARCHY" (
...
ALTER TABLE ONLY public."PROJECT_HIERARCHY"
...
CREATE INDEX "COMPONENT_PROPERTY_COMPONENT_ID_IDX" ON public."COMPONENT_PROPERTY" USING btree ("COMPONENT_ID");
...
CREATE UNIQUE INDEX "PROJECT_METADATA_PROJECT_ID_IDX" ON public."PROJECT_METADATA" USING btree ("PROJECT_ID");
...
CREATE TRIGGER trigger_project_hierarchy_maintenance_on_project_update AFTER UPDATE OF "PARENT_PROJECT_ID" ON public."PROJECT" FOR EACH ROW EXECUTE PROCEDURE public.project_hierarchy_maintenance_on_project_update();
...
ALTER TABLE ONLY public."AFFECTEDVERSIONATTRIBUTION"
    ADD CONSTRAINT "AFFECTEDVERSIONATTRIBUTION_VULNERABLESOFTWARE_FK" FOREIGN KEY ("VULNERABLE_SOFTWARE") REFERENCES public."VULNERABLESOFTWARE"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."ANALYSISCOMMENT"
    ADD CONSTRAINT "ANALYSISCOMMENT_ANALYSIS_FK" FOREIGN KEY ("ANALYSIS_ID") REFERENCES public."ANALYSIS"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."ANALYSIS"
    ADD CONSTRAINT "ANALYSIS_COMPONENT_FK" FOREIGN KEY ("COMPONENT_ID") REFERENCES public."COMPONENT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."ANALYSIS"
    ADD CONSTRAINT "ANALYSIS_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."ANALYSIS"
    ADD CONSTRAINT "ANALYSIS_VULNERABILITY_FK" FOREIGN KEY ("VULNERABILITY_ID") REFERENCES public."VULNERABILITY"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY public."APIKEYS_TEAMS"
    ADD CONSTRAINT "APIKEYS_TEAMS_APIKEY_FK" FOREIGN KEY ("APIKEY_ID") REFERENCES public."APIKEY"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."APIKEYS_TEAMS"
    ADD CONSTRAINT "APIKEYS_TEAMS_TEAM_FK" FOREIGN KEY ("TEAM_ID") REFERENCES public."TEAM"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."BOM"
    ADD CONSTRAINT "BOM_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."COMPONENTS_VULNERABILITIES"
    ADD CONSTRAINT "COMPONENTS_VULNERABILITIES_COMPONENT_FK" FOREIGN KEY ("COMPONENT_ID") REFERENCES public."COMPONENT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."COMPONENTS_VULNERABILITIES"
    ADD CONSTRAINT "COMPONENTS_VULNERABILITIES_VULNERABILITY_FK" FOREIGN KEY ("VULNERABILITY_ID") REFERENCES public."VULNERABILITY"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."COMPONENT"
    ADD CONSTRAINT "COMPONENT_COMPONENT_FK" FOREIGN KEY ("PARENT_COMPONENT_ID") REFERENCES public."COMPONENT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."COMPONENT"
    ADD CONSTRAINT "COMPONENT_LICENSE_FK" FOREIGN KEY ("LICENSE_ID") REFERENCES public."LICENSE"("ID") DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."COMPONENT"
    ADD CONSTRAINT "COMPONENT_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY public."DEPENDENCYMETRICS"
    ADD CONSTRAINT "DEPENDENCYMETRICS_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."FINDINGATTRIBUTION"
    ADD CONSTRAINT "FINDINGATTRIBUTION_COMPONENT_FK" FOREIGN KEY ("COMPONENT_ID") REFERENCES public."COMPONENT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."FINDINGATTRIBUTION"
    ADD CONSTRAINT "FINDINGATTRIBUTION_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."FINDINGATTRIBUTION"
    ADD CONSTRAINT "FINDINGATTRIBUTION_VULNERABILITY_FK" FOREIGN KEY ("VULNERABILITY_ID") REFERENCES public."VULNERABILITY"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."INTEGRITY_ANALYSIS"
    ADD CONSTRAINT "INTEGRITY_ANALYSIS_COMPONENT_FK" FOREIGN KEY ("COMPONENT_ID") REFERENCES public."COMPONENT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."LDAPUSERS_PERMISSIONS"
    ADD CONSTRAINT "LDAPUSERS_PERMISSIONS_LDAPUSER_FK" FOREIGN KEY ("LDAPUSER_ID") REFERENCES public."LDAPUSER"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."LDAPUSERS_PERMISSIONS"
    ADD CONSTRAINT "LDAPUSERS_PERMISSIONS_PERMISSION_FK" FOREIGN KEY ("PERMISSION_ID") REFERENCES public."PERMISSION"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."LDAPUSERS_TEAMS"
    ADD CONSTRAINT "LDAPUSERS_TEAMS_LDAPUSER_FK" FOREIGN KEY ("LDAPUSER_ID") REFERENCES public."LDAPUSER"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."LDAPUSERS_TEAMS"
    ADD CONSTRAINT "LDAPUSERS_TEAMS_TEAM_FK" FOREIGN KEY ("TEAM_ID") REFERENCES public."TEAM"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."LICENSEGROUP_LICENSE"
    ADD CONSTRAINT "LICENSEGROUP_LICENSE_LICENSEGROUP_FK" FOREIGN KEY ("LICENSEGROUP_ID") REFERENCES public."LICENSEGROUP"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."LICENSEGROUP_LICENSE"
    ADD CONSTRAINT "LICENSEGROUP_LICENSE_LICENSE_FK" FOREIGN KEY ("LICENSE_ID") REFERENCES public."LICENSE"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."MANAGEDUSERS_PERMISSIONS"
    ADD CONSTRAINT "MANAGEDUSERS_PERMISSIONS_MANAGEDUSER_FK" FOREIGN KEY ("MANAGEDUSER_ID") REFERENCES public."MANAGEDUSER"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."MANAGEDUSERS_PERMISSIONS"
    ADD CONSTRAINT "MANAGEDUSERS_PERMISSIONS_PERMISSION_FK" FOREIGN KEY ("PERMISSION_ID") REFERENCES public."PERMISSION"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."MANAGEDUSERS_TEAMS"
    ADD CONSTRAINT "MANAGEDUSERS_TEAMS_MANAGEDUSER_FK" FOREIGN KEY ("MANAGEDUSER_ID") REFERENCES public."MANAGEDUSER"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."MANAGEDUSERS_TEAMS"
    ADD CONSTRAINT "MANAGEDUSERS_TEAMS_TEAM_FK" FOREIGN KEY ("TEAM_ID") REFERENCES public."TEAM"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."MAPPEDLDAPGROUP"
    ADD CONSTRAINT "MAPPEDLDAPGROUP_TEAM_FK" FOREIGN KEY ("TEAM_ID") REFERENCES public."TEAM"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."MAPPEDOIDCGROUP"
    ADD CONSTRAINT "MAPPEDOIDCGROUP_OIDCGROUP_FK" FOREIGN KEY ("GROUP_ID") REFERENCES public."OIDCGROUP"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."MAPPEDOIDCGROUP"
    ADD CONSTRAINT "MAPPEDOIDCGROUP_TEAM_FK" FOREIGN KEY ("TEAM_ID") REFERENCES public."TEAM"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."NOTIFICATIONRULE"
    ADD CONSTRAINT "NOTIFICATIONRULE_NOTIFICATIONPUBLISHER_FK" FOREIGN KEY ("PUBLISHER") REFERENCES public."NOTIFICATIONPUBLISHER"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."NOTIFICATIONRULE_PROJECTS"
    ADD CONSTRAINT "NOTIFICATIONRULE_PROJECTS_NOTIFICATIONRULE_FK" FOREIGN KEY ("NOTIFICATIONRULE_ID") REFERENCES public."NOTIFICATIONRULE"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."NOTIFICATIONRULE_PROJECTS"
    ADD CONSTRAINT "NOTIFICATIONRULE_PROJECTS_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."NOTIFICATIONRULE_TAGS"
    ADD CONSTRAINT "NOTIFICATIONRULE_TAGS_NOTIFICATIONRULE_FK" FOREIGN KEY ("NOTIFICATIONRULE_ID") REFERENCES public."NOTIFICATIONRULE"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."NOTIFICATIONRULE_TAGS"
    ADD CONSTRAINT "NOTIFICATIONRULE_TAGS_TAG_FK" FOREIGN KEY ("TAG_ID") REFERENCES public."TAG"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."NOTIFICATIONRULE_TEAMS"
    ADD CONSTRAINT "NOTIFICATIONRULE_TEAMS_NOTIFICATIONRULE_FK" FOREIGN KEY ("NOTIFICATIONRULE_ID") REFERENCES public."NOTIFICATIONRULE"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."NOTIFICATIONRULE_TEAMS"
    ADD CONSTRAINT "NOTIFICATIONRULE_TEAMS_TEAM_FK" FOREIGN KEY ("TEAM_ID") REFERENCES public."TEAM"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."OIDCUSERS_PERMISSIONS"
    ADD CONSTRAINT "OIDCUSERS_PERMISSIONS_OIDCUSER_FK" FOREIGN KEY ("OIDCUSER_ID") REFERENCES public."OIDCUSER"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."OIDCUSERS_PERMISSIONS"
    ADD CONSTRAINT "OIDCUSERS_PERMISSIONS_PERMISSION_FK" FOREIGN KEY ("PERMISSION_ID") REFERENCES public."PERMISSION"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."OIDCUSERS_TEAMS"
    ADD CONSTRAINT "OIDCUSERS_TEAMS_OIDCUSER_FK" FOREIGN KEY ("OIDCUSERS_ID") REFERENCES public."OIDCUSER"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."OIDCUSERS_TEAMS"
    ADD CONSTRAINT "OIDCUSERS_TEAMS_TEAM_FK" FOREIGN KEY ("TEAM_ID") REFERENCES public."TEAM"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."POLICYCONDITION"
    ADD CONSTRAINT "POLICYCONDITION_POLICY_FK" FOREIGN KEY ("POLICY_ID") REFERENCES public."POLICY"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."POLICYVIOLATION"
    ADD CONSTRAINT "POLICYVIOLATION_COMPONENT_FK" FOREIGN KEY ("COMPONENT_ID") REFERENCES public."COMPONENT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."POLICYVIOLATION"
    ADD CONSTRAINT "POLICYVIOLATION_POLICYCONDITION_FK" FOREIGN KEY ("POLICYCONDITION_ID") REFERENCES public."POLICYCONDITION"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."POLICYVIOLATION"
    ADD CONSTRAINT "POLICYVIOLATION_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."POLICY_PROJECTS"
    ADD CONSTRAINT "POLICY_PROJECTS_POLICY_FK" FOREIGN KEY ("POLICY_ID") REFERENCES public."POLICY"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."POLICY_PROJECTS"
    ADD CONSTRAINT "POLICY_PROJECTS_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."POLICY_TAGS"
    ADD CONSTRAINT "POLICY_TAGS_POLICY_FK" FOREIGN KEY ("POLICY_ID") REFERENCES public."POLICY"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."POLICY_TAGS"
    ADD CONSTRAINT "POLICY_TAGS_TAG_FK" FOREIGN KEY ("TAG_ID") REFERENCES public."TAG"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."PROJECTMETRICS"
    ADD CONSTRAINT "PROJECTMETRICS_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."PROJECTS_TAGS"
    ADD CONSTRAINT "PROJECTS_TAGS_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."PROJECTS_TAGS"
    ADD CONSTRAINT "PROJECTS_TAGS_TAG_FK" FOREIGN KEY ("TAG_ID") REFERENCES public."TAG"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."PROJECT_ACCESS_TEAMS"
    ADD CONSTRAINT "PROJECT_ACCESS_TEAMS_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."PROJECT_ACCESS_TEAMS"
    ADD CONSTRAINT "PROJECT_ACCESS_TEAMS_TEAM_FK" FOREIGN KEY ("TEAM_ID") REFERENCES public."TEAM"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."PROJECT_HIERARCHY"
    ADD CONSTRAINT "PROJECT_HIERARCHY_CHILD_PROJECT_FK" FOREIGN KEY ("CHILD_PROJECT_ID") REFERENCES public."PROJECT"("ID") DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."PROJECT_HIERARCHY"
    ADD CONSTRAINT "PROJECT_HIERARCHY_PARENT_PROJECT_FK" FOREIGN KEY ("PARENT_PROJECT_ID") REFERENCES public."PROJECT"("ID") DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."PROJECT_METADATA"
    ADD CONSTRAINT "PROJECT_METADATA_PROJECT_ID_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."PROJECT"
    ADD CONSTRAINT "PROJECT_PROJECT_FK" FOREIGN KEY ("PARENT_PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY public."SERVICECOMPONENTS_VULNERABILITIES"
    ADD CONSTRAINT "SERVICECOMPONENTS_VULNERABILITIES_VULNERABILITY_FK" FOREIGN KEY ("VULNERABILITY_ID") REFERENCES public."VULNERABILITY"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."SERVICECOMPONENT"
    ADD CONSTRAINT "SERVICECOMPONENT_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."SERVICECOMPONENT"
    ADD CONSTRAINT "SERVICECOMPONENT_SERVICECOMPONENT_FK" FOREIGN KEY ("PARENT_SERVICECOMPONENT_ID") REFERENCES public."SERVICECOMPONENT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."TEAMS_PERMISSIONS"
    ADD CONSTRAINT "TEAMS_PERMISSIONS_PERMISSION_FK" FOREIGN KEY ("PERMISSION_ID") REFERENCES public."PERMISSION"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY public."VIOLATIONANALYSISCOMMENT"
    ADD CONSTRAINT "VIOLATIONANALYSISCOMMENT_VIOLATIONANALYSIS_FK" FOREIGN KEY ("VIOLATIONANALYSIS_ID") REFERENCES public."VIOLATIONANALYSIS"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."VIOLATIONANALYSIS"
    ADD CONSTRAINT "VIOLATIONANALYSIS_COMPONENT_FK" FOREIGN KEY ("COMPONENT_ID") REFERENCES public."COMPONENT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."VIOLATIONANALYSIS"
    ADD CONSTRAINT "VIOLATIONANALYSIS_POLICYVIOLATION_FK" FOREIGN KEY ("POLICYVIOLATION_ID") REFERENCES public."POLICYVIOLATION"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."VIOLATIONANALYSIS"
    ADD CONSTRAINT "VIOLATIONANALYSIS_PROJECT_FK" FOREIGN KEY ("PROJECT_ID") REFERENCES public."PROJECT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."VULNERABILITIES_TAGS"
    ADD CONSTRAINT "VULNERABILITIES_TAGS_TAG_FK" FOREIGN KEY ("TAG_ID") REFERENCES public."TAG"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."VULNERABILITIES_TAGS"
    ADD CONSTRAINT "VULNERABILITIES_TAGS_VULNERABILITY_FK" FOREIGN KEY ("VULNERABILITY_ID") REFERENCES public."VULNERABILITY"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."VULNERABLESOFTWARE_VULNERABILITIES"
    ADD CONSTRAINT "VULNERABLESOFTWARE_VULNERABILITIES_VULNERABILITY_FK" FOREIGN KEY ("VULNERABILITY_ID") REFERENCES public."VULNERABILITY"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."VULNERABLESOFTWARE_VULNERABILITIES"
    ADD CONSTRAINT "VULNERABLESOFTWARE_VULNERABILITIES_VULNERABLESOFTWARE_FK" FOREIGN KEY ("VULNERABLESOFTWARE_ID") REFERENCES public."VULNERABLESOFTWARE"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public."WORKFLOW_STATE"
    ADD CONSTRAINT "WORKFLOW_STATE_WORKFLOW_STATE_FK" FOREIGN KEY ("PARENT_STEP_ID") REFERENCES public."WORKFLOW_STATE"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
