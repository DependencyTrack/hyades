...
-- Ran at: 8/5/24, 2:25 PM
-- Against: dtrack@jdbc:postgresql://localhost:32853/dtrack
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-2', 'nscuro@protonmail.com', 'migration/changelog-v5.3.0.xml', NOW(), 2, '9:517d11a50b5ced1713523790ba3bcae4', 'customChange', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');

-- Changeset migration/changelog-v5.3.0.xml::v5.3.0-3::VithikaS
-- WARNING The following SQL may change each run and therefore is possibly incorrect and/or invalid:
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-3', 'VithikaS', 'migration/changelog-v5.3.0.xml', NOW(), 3, '9:ee0beaad46c8e53c67cdaba2078b3807', 'customChange', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-4', 'VithikaS', 'migration/changelog-v5.3.0.xml', NOW(), 4, '9:7862672bed2288bc1fd22fedc48faed7', 'createTable tableName=VULNERABILITY_POLICY', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-6', 'sahibamittal', 'migration/changelog-v5.3.0.xml', NOW(), 6, '9:dfa7456dd92ba75e3c70415f816cc06d', 'addColumn tableName=ANALYSIS', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-8', 'nscuro@protonmail.com', 'migration/changelog-v5.3.0.xml', NOW(), 8, '9:31a1e91e36e2a26e106445a8b30807d3', 'addColumn tableName=ANALYSIS; addForeignKeyConstraint baseTableName=ANALYSIS, constraintName=ANALYSIS_VULNERABILITY_POLICY_ID_FK, referencedTableName=VULNERABILITY_POLICY', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-10', 'sahibamittal', 'migration/changelog-v5.3.0.xml', NOW(), 10, '9:f949af110fa2b959b38090997161f594', 'addColumn tableName=NOTIFICATIONRULE', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-11', 'nscuro@protonmail.com', 'migration/changelog-v5.3.0.xml', NOW(), 11, '9:c020c3afe2cd80c3b794954946d953d4', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');

-- Changeset migration/changelog-v5.3.0.xml::v5.3.0-12::sahibamittal
DROP TABLE "CPE";

INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-12', 'sahibamittal', 'migration/changelog-v5.3.0.xml', NOW(), 12, '9:d016a4c841a5eedc0c14f43a0e656636', 'dropTable tableName=CPE', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');

-- Changeset migration/changelog-v5.3.0.xml::v5.3.0-13::nscuro@protonmail.com
CREATE EXTENSION IF NOT EXISTS PG_TRGM;

INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-13', 'nscuro@protonmail.com', 'migration/changelog-v5.3.0.xml', NOW(), 13, '9:a0dc400a05beb0c54c46115f6c767926', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-15', 'sahibamittal', 'migration/changelog-v5.3.0.xml', NOW(), 15, '9:bcb140e9c76c2f720b69c5cd210f8149', 'createTable tableName=PROJECT_METADATA; addForeignKeyConstraint baseTableName=PROJECT_METADATA, constraintName=PROJECT_METADATA_PROJECT_ID_FK, referencedTableName=PROJECT; addColumn tableName=COMPONENT; addColumn tableName=PROJECT', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');

-- Changeset migration/changelog-v5.4.0.xml::v5.4.0-1::nscuro@protonmail.com
ALTER TABLE "PROJECT_METADATA" ADD "TOOLS" TEXT;

INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.4.0-1', 'nscuro@protonmail.com', 'migration/changelog-v5.4.0.xml', NOW(), 16, '9:16f1130d4a0a8de85660ce3b2594031e', 'addColumn tableName=PROJECT_METADATA', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-1', 'nscuro@protonmail.com', 'migration/changelog-v5.5.0.xml', NOW(), 18, '9:7d41edd5a8a6f52e0fc9df507b4e1130', 'addColumn tableName=APIKEY', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-6', 'nscuro', 'migration/changelog-v5.5.0.xml', NOW(), 23, '9:7a29b11e1b913aaa5394d56f3d35096a', 'modifyDataType columnName=DESCRIPTION, tableName=VULNERABILITY_POLICY', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-7', 'sahibamittal', 'migration/changelog-v5.5.0.xml', NOW(), 24, '9:4c05b1489b0ad2acdcb1ba454af448d3', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');

-- Changeset migration/changelog-v5.5.0.xml::v5.5.0-8::nscuro
DROP TABLE "CWE";

INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-8', 'nscuro', 'migration/changelog-v5.5.0.xml', NOW(), 25, '9:461b965fb154668f93bc21471adb4522', 'dropTable tableName=CWE', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-9', 'sahibamittal', 'migration/changelog-v5.5.0.xml', NOW(), 26, '9:05667de88f118ce836fc3c4e2785a1dc', 'addColumn tableName=VULNERABILITY_POLICY', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-12', 'sahibamittal', 'migration/changelog-v5.5.0.xml', NOW(), 29, '9:8fc403950e57ba0f8ff3be9709cf0988', 'modifyDataType columnName=GROUPNAME, tableName=COMPONENT_PROPERTY; modifyDataType columnName=PROPERTYNAME, tableName=COMPONENT_PROPERTY; modifyDataType columnName=PROPERTYVALUE, tableName=COMPONENT_PROPERTY; modifyDataType columnName=DESCRIPTION, ...', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
-- Changeset migration/changelog-v5.6.0.xml::v5.6.0-1::nscuro
CREATE TABLE "BOM_UPLOAD" ("TOKEN" UUID NOT NULL, "UPLOADED_AT" TIMESTAMP WITH TIME ZONE NOT NULL, "BOM" BYTEA NOT NULL, CONSTRAINT "BOM_UPLOAD_PK" PRIMARY KEY ("TOKEN"));

INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.6.0-1', 'nscuro', 'migration/changelog-v5.6.0.xml', NOW(), 32, '9:4307ac116f61699e85cb5079288cfe62', 'createTable tableName=BOM_UPLOAD', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('function_calc-risk-score', 'nscuro@protonmail.com', 'migration/changelog-procedures.xml', NOW(), 33, '9:a0bb5d32594686d29aab5ddcda849556', 'createProcedure path=procedures/function_calc-risk-score.sql', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('procedure_update-component-metrics', 'nscuro@protonmail.com', 'migration/changelog-procedures.xml', NOW(), 34, '9:e6df4d01af9019e007df9ae9e770eade', 'createProcedure path=procedures/procedure_update-component-metrics.sql', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('procedure_update-project-metrics', 'nscuro@protonmail.com', 'migration/changelog-procedures.xml', NOW(), 35, '9:a7b35b9d37fa1deeb3044ace83dc9952', 'createProcedure path=procedures/procedure_update-project-metrics.sql', '', 'EXECUTED', NULL, NULL, '4.29.1', '2860744978');
