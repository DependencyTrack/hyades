...
CREATE TABLE public."COMPONENT_OCCURRENCE" (
    "ID" uuid NOT NULL,
    "COMPONENT_ID" bigint NOT NULL,
...
ALTER TABLE ONLY public."COMPONENT_OCCURRENCE"
    ADD CONSTRAINT "COMPONENT_OCCURRENCE_COMPONENT_FK" FOREIGN KEY ("COMPONENT_ID") REFERENCES public."COMPONENT"("ID") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
