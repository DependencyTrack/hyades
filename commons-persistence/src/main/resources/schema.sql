...
-- Ran at: 6/26/24, 11:56 AM
-- Against: dtrack@jdbc:postgresql://localhost:32770/dtrack
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-2', 'nscuro@protonmail.com', 'migration/changelog-v5.3.0.xml', NOW(), 2, '9:517d11a50b5ced1713523790ba3bcae4', 'customChange', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');

-- Changeset migration/changelog-v5.3.0.xml::v5.3.0-3::VithikaS
SET SEARCH_PATH TO public, "$user","public";

-- WARNING The following SQL may change each run and therefore is possibly incorrect and/or invalid:
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-3', 'VithikaS', 'migration/changelog-v5.3.0.xml', NOW(), 3, '9:ee0beaad46c8e53c67cdaba2078b3807', 'customChange', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-4', 'VithikaS', 'migration/changelog-v5.3.0.xml', NOW(), 4, '9:7862672bed2288bc1fd22fedc48faed7', 'createTable tableName=VULNERABILITY_POLICY', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-6', 'sahibamittal', 'migration/changelog-v5.3.0.xml', NOW(), 6, '9:dfa7456dd92ba75e3c70415f816cc06d', 'addColumn tableName=ANALYSIS', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-8', 'nscuro@protonmail.com', 'migration/changelog-v5.3.0.xml', NOW(), 8, '9:31a1e91e36e2a26e106445a8b30807d3', 'addColumn tableName=ANALYSIS; addForeignKeyConstraint baseTableName=ANALYSIS, constraintName=ANALYSIS_VULNERABILITY_POLICY_ID_FK, referencedTableName=VULNERABILITY_POLICY', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-10', 'sahibamittal', 'migration/changelog-v5.3.0.xml', NOW(), 10, '9:f949af110fa2b959b38090997161f594', 'addColumn tableName=NOTIFICATIONRULE', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-11', 'nscuro@protonmail.com', 'migration/changelog-v5.3.0.xml', NOW(), 11, '9:c020c3afe2cd80c3b794954946d953d4', 'sql', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-12', 'sahibamittal', 'migration/changelog-v5.3.0.xml', NOW(), 12, '9:d016a4c841a5eedc0c14f43a0e656636', 'dropTable tableName=CPE', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-15', 'sahibamittal', 'migration/changelog-v5.3.0.xml', NOW(), 15, '9:bcb140e9c76c2f720b69c5cd210f8149', 'createTable tableName=PROJECT_METADATA; addForeignKeyConstraint baseTableName=PROJECT_METADATA, constraintName=PROJECT_METADATA_PROJECT_ID_FK, referencedTableName=PROJECT; addColumn tableName=COMPONENT; addColumn tableName=PROJECT', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-1', 'nscuro@protonmail.com', 'migration/changelog-v5.5.0.xml', NOW(), 18, '9:7d41edd5a8a6f52e0fc9df507b4e1130', 'addColumn tableName=APIKEY', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-3', 'sahibamittal', 'migration/changelog-v5.5.0.xml', NOW(), 20, '9:e9e7e23dd6f5efb9b0a04e9d3f35c3e9', 'addColumn tableName=BOM', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-6', 'nscuro', 'migration/changelog-v5.5.0.xml', NOW(), 23, '9:7a29b11e1b913aaa5394d56f3d35096a', 'modifyDataType columnName=DESCRIPTION, tableName=VULNERABILITY_POLICY', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-7', 'sahibamittal', 'migration/changelog-v5.5.0.xml', NOW(), 24, '9:4c05b1489b0ad2acdcb1ba454af448d3', 'sql', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-8', 'nscuro', 'migration/changelog-v5.5.0.xml', NOW(), 25, '9:461b965fb154668f93bc21471adb4522', 'dropTable tableName=CWE', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-9', 'sahibamittal', 'migration/changelog-v5.5.0.xml', NOW(), 26, '9:05667de88f118ce836fc3c4e2785a1dc', 'addColumn tableName=VULNERABILITY_POLICY', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');

-- Changeset migration/changelog-v5.5.0.xml::v5.5.0-10::sahibamittal
SET SEARCH_PATH TO public, "$user","public";

CREATE TABLE "COMPONENT_PROPERTY" ("ID" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "COMPONENT_ID" BIGINT NOT NULL, "GROUPNAME" TEXT, "PROPERTYNAME" TEXT NOT NULL, "PROPERTYVALUE" TEXT, "PROPERTYTYPE" TEXT NOT NULL, "DESCRIPTION" TEXT, "UUID" TEXT NOT NULL, CONSTRAINT "COMPONENT_PROPERTY_PK" PRIMARY KEY ("ID"));
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-11', 'nscuro', 'migration/changelog-v5.5.0.xml', NOW(), 28, '9:21577dbfa3c64bb5d2ce44d5f1360fdc', 'customChange; sql', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');

-- Changeset migration/changelog-v5.5.0.xml::v5.5.0-12::sahibamittal
SET SEARCH_PATH TO public, "$user","public";

ALTER TABLE "COMPONENT_PROPERTY" ALTER COLUMN "GROUPNAME" TYPE VARCHAR(255) USING ("GROUPNAME"::VARCHAR(255));

ALTER TABLE "COMPONENT_PROPERTY" ALTER COLUMN "PROPERTYNAME" TYPE VARCHAR(255) USING ("PROPERTYNAME"::VARCHAR(255));

ALTER TABLE "COMPONENT_PROPERTY" ALTER COLUMN "PROPERTYVALUE" TYPE VARCHAR(1024) USING ("PROPERTYVALUE"::VARCHAR(1024));

ALTER TABLE "COMPONENT_PROPERTY" ALTER COLUMN "DESCRIPTION" TYPE VARCHAR(255) USING ("DESCRIPTION"::VARCHAR(255));

INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-12', 'sahibamittal', 'migration/changelog-v5.5.0.xml', NOW(), 29, '9:8fc403950e57ba0f8ff3be9709cf0988', 'modifyDataType columnName=GROUPNAME, tableName=COMPONENT_PROPERTY; modifyDataType columnName=PROPERTYNAME, tableName=COMPONENT_PROPERTY; modifyDataType columnName=PROPERTYVALUE, tableName=COMPONENT_PROPERTY; modifyDataType columnName=DESCRIPTION, ...', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');

-- Changeset migration/changelog-v5.5.0.xml::v5.5.0-13::nscuro
SET SEARCH_PATH TO public, "$user","public";
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-13', 'nscuro', 'migration/changelog-v5.5.0.xml', NOW(), 30, '9:3468e3d00ad4c88ef9377fd31401ecd4', 'sql; addDefaultValue columnName=ACTIVE, tableName=PROJECT; addNotNullConstraint columnName=ACTIVE, tableName=PROJECT', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');

-- Changeset migration/changelog-v5.5.0.xml::v5.5.0-14::nscuro
SET SEARCH_PATH TO public, "$user","public";

UPDATE "VULNERABILITY_POLICY" SET "OPERATION_MODE" = 'APPLY' WHERE "OPERATION_MODE" IS NULL;

ALTER TABLE "VULNERABILITY_POLICY" ALTER COLUMN  "OPERATION_MODE" SET DEFAULT 'APPLY';

ALTER TABLE "VULNERABILITY_POLICY" ALTER COLUMN  "OPERATION_MODE" SET NOT NULL;

INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-14', 'nscuro', 'migration/changelog-v5.5.0.xml', NOW(), 31, '9:fca42bd2be8336c00e754373bb5cefef', 'sql; addDefaultValue columnName=OPERATION_MODE, tableName=VULNERABILITY_POLICY; addNotNullConstraint columnName=OPERATION_MODE, tableName=VULNERABILITY_POLICY', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');

-- Changeset migration/changelog-v5.5.0.xml::v5.5.0-15::sahibamittal
ALTER TABLE "AFFECTEDVERSIONATTRIBUTION" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "BOM" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "COMPONENT" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "COMPONENT_PROPERTY" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "FINDINGATTRIBUTION" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "LICENSE" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "LICENSEGROUP" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "NOTIFICATIONPUBLISHER" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "NOTIFICATIONRULE" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "POLICY" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "POLICYCONDITION" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "POLICYVIOLATION" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "PROJECT" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "REPOSITORY" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "SERVICECOMPONENT" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "VEX" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "VULNERABILITY" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "VULNERABILITYALIAS" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "VULNERABILITYSCAN" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "VULNERABLESOFTWARE" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

ALTER TABLE "WORKFLOW_STATE" ALTER COLUMN "UUID" TYPE UUID USING ("UUID"::UUID);

INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-15', 'sahibamittal', 'migration/changelog-v5.5.0.xml', NOW(), 32, '9:d7781bc0f72ee4e36997df9b5ff73c67', 'modifyDataType columnName=UUID, tableName=AFFECTEDVERSIONATTRIBUTION; modifyDataType columnName=UUID, tableName=BOM; modifyDataType columnName=UUID, tableName=COMPONENT; modifyDataType columnName=UUID, tableName=COMPONENT_PROPERTY; modifyDataType ...', '', 'EXECUTED', NULL, NULL, '4.29.1', '3717197010');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('function_calc-risk-score', 'nscuro@protonmail.com', 'migration/changelog-procedures.xml', NOW(), 32, '9:a0bb5d32594686d29aab5ddcda849556', 'createProcedure path=procedures/function_calc-risk-score.sql', '', 'EXECUTED', NULL, NULL, '4.28.0', '9395800427');
