...
CREATE TABLE public."CSAFSOURCEENTITY" (
    "ID" bigint NOT NULL,
...
ALTER TABLE public."CSAFSOURCEENTITY" ALTER COLUMN "ID" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."CSAFSOURCEENTITY_ID_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public."CSAFDOCUMENTENTITY" (
    "ID" bigint NOT NULL,
    "NAME" character varying(255) NOT NULL,
    "URL" character varying(255),
    "SEEN" boolean,
    ...
    "TRACKINGVERSION" character varying(255) NOT NULL
);

ALTER TABLE public."CSAFDOCUMENTENTITY" ALTER COLUMN "ID" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."CSAFDOCUMENTENTITY_ID_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TRIGGER trigger_effective_permissions_mx_on_users_teams_insert AFTER INSERT ON public."USERS_TEAMS" REFERENCING NEW TABLE AS new_table FOR EACH STATEMENT EXECUTE FUNCTION public.effective_permissions_mx_on_insert();

CREATE TRIGGER trigger_effective_permissions_mx_on_users_teams_update AFTER UPDATE ON public."USERS_TEAMS" REFERENCING OLD TABLE AS old_table NEW TABLE AS new_table FOR EACH STATEMENT EXECUTE FUNCTION public.effective_permissions_mx_on_update();
...
ALTER TABLE public."PROJECTMETRICS"
...
ALTER TABLE ONLY public."USERS_PERMISSIONS"
    ADD CONSTRAINT "USERS_PERMISSIONS_PERMISSION_FK" FOREIGN KEY ("PERMISSION_ID") REFERENCES public."PERMISSION"("ID") ON DELETE CASCADE;

ALTER TABLE ONLY public."USERS_PERMISSIONS"
    ADD CONSTRAINT "USERS_PERMISSIONS_USER_FK" FOREIGN KEY ("USER_ID") REFERENCES public."USER"("ID") ON DELETE CASCADE;

ALTER TABLE ONLY public."USERS_TEAMS"
    ADD CONSTRAINT "USERS_TEAMS_TEAM_FK" FOREIGN KEY ("TEAM_ID") REFERENCES public."TEAM"("ID") ON DELETE CASCADE;

ALTER TABLE ONLY public."USERS_TEAMS"
    ADD CONSTRAINT "USERS_TEAMS_USER_FK" FOREIGN KEY ("USER_ID") REFERENCES public."USER"("ID") ON DELETE CASCADE;
