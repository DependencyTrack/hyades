...
-- Lock Database
UPDATE databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = 'devastation (192.168.178.40)', LOCKGRANTED = NOW() WHERE ID = 1 AND LOCKED = FALSE;
...
-- Ran at: 09/02/2024, 19:50
-- Against: dtrack@jdbc:postgresql://localhost:32813/dtrack
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-2', 'nscuro@protonmail.com', 'migration/changelog-v5.3.0.xml', NOW(), 2, '9:517d11a50b5ced1713523790ba3bcae4', 'customChange', '', 'EXECUTED', NULL, NULL, '4.25.0', '7504651784');

-- Changeset migration/changelog-v5.3.0.xml::v5.3.0-3::VithikaS
SET SEARCH_PATH TO public, "$user","public";

-- WARNING The following SQL may change each run and therefore is possibly incorrect and/or invalid:
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-3', 'VithikaS', 'migration/changelog-v5.3.0.xml', NOW(), 3, '9:ee0beaad46c8e53c67cdaba2078b3807', 'customChange', '', 'EXECUTED', NULL, NULL, '4.25.0', '7504651784');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-4', 'VithikaS', 'migration/changelog-v5.3.0.xml', NOW(), 4, '9:7862672bed2288bc1fd22fedc48faed7', 'createTable tableName=VULNERABILITY_POLICY', '', 'EXECUTED', NULL, NULL, '4.25.0', '7504651784');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-6', 'sahibamittal', 'migration/changelog-v5.3.0.xml', NOW(), 6, '9:dfa7456dd92ba75e3c70415f816cc06d', 'addColumn tableName=ANALYSIS', '', 'EXECUTED', NULL, NULL, '4.25.0', '7504651784');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-8', 'nscuro@protonmail.com', 'migration/changelog-v5.3.0.xml', NOW(), 8, '9:31a1e91e36e2a26e106445a8b30807d3', 'addColumn tableName=ANALYSIS; addForeignKeyConstraint baseTableName=ANALYSIS, constraintName=ANALYSIS_VULNERABILITY_POLICY_ID_FK, referencedTableName=VULNERABILITY_POLICY', '', 'EXECUTED', NULL, NULL, '4.25.0', '7504651784');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-10', 'sahibamittal', 'migration/changelog-v5.3.0.xml', NOW(), 10, '9:f949af110fa2b959b38090997161f594', 'addColumn tableName=NOTIFICATIONRULE', '', 'EXECUTED', NULL, NULL, '4.25.0', '7504651784');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-11', 'nscuro@protonmail.com', 'migration/changelog-v5.3.0.xml', NOW(), 11, '9:c020c3afe2cd80c3b794954946d953d4', 'sql', '', 'EXECUTED', NULL, NULL, '4.25.0', '7504651784');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.3.0-12', 'sahibamittal', 'migration/changelog-v5.3.0.xml', NOW(), 12, '9:d016a4c841a5eedc0c14f43a0e656636', 'dropTable tableName=CPE', '', 'EXECUTED', NULL, NULL, '4.25.0', '7504651784');
...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('function_calc-severity', 'nscuro@protonmail.com', 'migration/changelog-procedures.xml', NOW(), 17, '9:ecdf69ae9545f33a8e08020a6f5dbe61', 'createProcedure path=procedures/function_calc-severity.sql', '', 'EXECUTED', NULL, NULL, '4.25.0', '7504651784');
