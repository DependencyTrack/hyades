...
INSERT INTO databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('v5.5.0-12', 'sahibamittal', 'migration/changelog-v5.5.0.xml', NOW(), 29, '9:8fc403950e57ba0f8ff3be9709cf0988', 'modifyDataType columnName=GROUPNAME, tableName=COMPONENT_PROPERTY; modifyDataType columnName=PROPERTYNAME, tableName=COMPONENT_PROPERTY; modifyDataType columnName=PROPERTYVALUE, tableName=COMPONENT_PROPERTY; modifyDataType columnName=DESCRIPTION, ...', '', 'EXECUTED', NULL, NULL, '4.28.0', '8725358372');
