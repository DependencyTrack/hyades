...
CREATE TABLE IF NOT EXISTS public."CSAFSOURCEENTITY"
(
    "ID" bigint NOT NULL,
    ...
    CONSTRAINT "CSAFSOURCEENTITY_PK" PRIMARY KEY ("ID")
);
...
CREATE TABLE IF NOT EXISTS public."CSAFDOCUMENTENTITY"
(
    ...
    "ENABLED" boolean NOT NULL,
    "FETCHINTERVAL" integer NOT NULL,
    "LASTFETCHED" bigint NOT NULL,
    "NAME" character varying(255) COLLATE pg_catalog."default",
    "SEEN" boolean NOT NULL,
    "URL" character varying(255) COLLATE pg_catalog."default",
    CONSTRAINT "CSAFDOCUMENTENTITY_PK" PRIMARY KEY ("ID")
);
