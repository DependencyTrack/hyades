...
public final class NvdCveApiBuilder {
     ...
     * @return the builder
     */
    public NvdCveApiBuilder withLastModifiedFilter(ZonedDateTime utcStartDate, ZonedDateTime utcEndDate) {
     ...
     * @return the builder
     */
    public NvdCveApiBuilder withPublishedDateFilter(ZonedDateTime utcStartDate, ZonedDateTime utcEndDate) {
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("uuuu-MM-dd'T'HH:mm:ssX");
     ...
     */
    public NvdCveApiBuilder withVirtualMatchString(String virtualMatchString) {
     ...
     */
    public NvdCveApiBuilder withVersionStart(String versionStart) {
     ...
     * @see <a href="https://nvd.nist.gov/developers/vulnerabilities#cves-versionStart">cves-versionStart</a>
     */
    public NvdCveApiBuilder withVersionStart(String versionStart, VersionType startType) {
        withFilter("versionStart", versionStart);
     ...
     */
    public NvdCveApiBuilder withVersionEnd(String versionEnd) {
     ...
     * @see <a href="https://nvd.nist.gov/developers/vulnerabilities#cves-versionEnd">cves-versionEnd</a>
     */
    public NvdCveApiBuilder withVersionEnd(String versionEnd, VersionType endType) {
        withFilter("versionEnd", versionEnd);
