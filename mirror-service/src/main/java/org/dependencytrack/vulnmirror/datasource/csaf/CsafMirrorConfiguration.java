...
class CsafMirrorConfiguration {
    ...
    ExecutorService executorService() {
        ...
        final var threadFactory = new BasicThreadFactory.Builder()
                ...
                .uncaughtExceptionHandler(new LoggingUncaughtExceptionHandler(csafMirrorLogger))
                .build();

        return new ThreadPoolExecutor(1, 1, 0L, TimeUnit.MILLISECONDS,
                new LinkedBlockingQueue<>(1), threadFactory, new LoggingRejectedExecutionHandler(csafMirrorLogger));
    }
