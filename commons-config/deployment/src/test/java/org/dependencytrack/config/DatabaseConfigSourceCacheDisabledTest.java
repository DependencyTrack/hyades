...
public class DatabaseConfigSourceCacheDisabledTest extends AbstractDatabaseConfigSourceTest {

    @RegisterExtension
    static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addAsResource("application-nocache.properties", "application.properties"));
