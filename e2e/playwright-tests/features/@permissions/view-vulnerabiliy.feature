Feature: VIEW_PORTFOLIO x VIEW_VULNERABILITY
  Scenario: Without VIEW_VULNERABILITY Permission User Cannot See Management Buttons For Projects
  ...
  Scenario: With VIEW_VULNERABILITY Permission User Can See Management Buttons For Projects
