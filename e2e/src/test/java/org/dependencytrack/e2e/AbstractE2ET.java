...
public class AbstractE2ET {
    ...
    private void runInitializer() {
        new GenericContainer<>(API_SERVER_IMAGE)
                ...
                .withEnv("DT_DATASOURCE_INIT_TASKS_URL", "jdbc:postgresql://postgres:5432/dtrack")
                .withEnv("DT_DATASOURCE_INIT_TASKS_USERNAME", "dtrack")
                .withEnv("DT_DATASOURCE_INIT_TASKS_PASSWORD", "dtrack")
                .withEnv("INIT_TASKS_ENABLED", "true")
                .withEnv("INIT_TASKS_DATASOURCE_NAME", "init-tasks")
    ...
    private GenericContainer<?> createApiServerContainer() {
        final var container = new GenericContainer<>(API_SERVER_IMAGE)
                ...
                .withEnv("DT_DATASOURCE_URL", "jdbc:postgresql://postgres:5432/dtrack?reWriteBatchedInserts=true")
